...
var FlashChart = new Class({
	...
	initialize: function(element, options) {
		...
		this.so = new SWFObject(ls_root_url("/modules/backend/skins/lemon/assets/swf/am"+this.options.type+".swf"), this.chart_id, "100%", "100%", "8", "#FFFFFF");
		this.so.addVariable("path", escape(ls_root_url('/modules/backend/skins/lemon/assets/swf/')));
		this.so.addVariable("settings_file", 
			encodeURIComponent(ls_root_url('/modules/backend/skins/lemon/assets/xml/chart_common_settings.xml')) + ',' +
			encodeURIComponent(ls_root_url('/modules/backend/skins/lemon/assets/xml/chart_'+this.options.type+'_settings.xml')) + ',' +
